...
const AddSpace = () => {
  ...
  useEffect(() => {
    ...
    const fetchServices = async () => {
      try {
        const response = await axios.get("https://nomad-739samscb-silgurlekians-projects.vercel.app/api/services");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("https://nomad-739samscb-silgurlekians-projects.vercel.app/api/spaces", spaceData, config);
      navigate("/SpacesList");
    } catch (error) {
