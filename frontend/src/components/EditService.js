...
const EditService = () => {
  ...
  useEffect(() => {
    ...
    const fetchService = async () => {
      try {
        const response = await axios.get(`https://nomad-znm2.onrender.com/api/services/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://nomad-znm2.onrender.com/api/services/${id}`, updatedService);
